        ...
        <section id="achievements" className="py-20 px-4 md:px-8 lg:px-16 relative">
            <div className="max-w-6xl mx-auto">
                <div className="text-center mb-16">
                    <span className="text-[rgba(255,0,0,0.8)] font-doto font-bold text-sm uppercase tracking-widest">Recognition</span>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    {achievements.map((achievement, index) => (
                        <div
                            key={index}
                            className="group relative p-8 rounded-2xl border border-primary/10 bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-sm hover:border-red-500/30 transition-all duration-300 hover:shadow-xl hover:shadow-red-500/5 hover:-translate-y-1"
                        >
                            {/* Decorative gradient */}
                            ...
                            <div className="relative">
                                ...
                                <h3 className="text-xl font-hedvig font-bold text-[#222] group-hover:text-red-500 transition-colors mb-4">
                                    {achievement.title}
                                </h3>

                                <p className="text-[#555] font-doto leading-relaxed">
                ...
                <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6">
                    {[
                        ...
                        <div
                            key={index}
                            className="text-center p-6 rounded-2xl border border-primary/10 bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-sm hover:border-red-500/30 transition-all duration-300"
                        >
                            <stat.icon className="w-8 h-8 mx-auto mb-3 text-red-500" />
                            <div className="text-3xl font-hedvig font-bold text-black">{stat.value}</div>
